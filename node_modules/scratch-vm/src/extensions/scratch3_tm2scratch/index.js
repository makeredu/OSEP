...
class Scratch3TM2ScratchBlocks {
        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    arguments: {
                        LABEL: {
                            ...
                            defaultValue:
                                msg.Message.any_without_of[this.locale],
                        },
                    },
                },
                {
                ...
                },
                {
                    ...
                    text: msg.Message.image_classification_model_url[
                        this.locale
                    ],
                    ...
                    arguments: {
                        URL: {
                            type: ArgumentType.STRING,
                            defaultValue:
                                "https://teachablemachine.withgoogle.com/models/QpU-E7V1C/",
                        },
                    },
                },
                {
                ...
                "---",
                {
                    ...
                    text: msg.Message.when_received_sound_label_block[
                        this.locale
                    ],
                    blockType: BlockType.HAT,
                    arguments: {
                ...
                },
                {
                    ...
                    text: msg.Message.sound_classification_model_url[
                        this.locale
                    ],
                    blockType: BlockType.COMMAND,
                    arguments: {
                        URL: {
                            type: ArgumentType.STRING,
                            defaultValue:
                                "https://teachablemachine.withgoogle.com/models/RydwAtgBB/",
    ...
    //1110104 add
    getImageLabel() {
        if (this.ImageLabelConfidence == false) {
            if (
                !this.imageProbableLabels ||
                this.imageProbableLabels.length === 0
            )
                return msg.Message.confidence_level[this.locale];
            this.ImageLabelConfidence = true;
        }
    ...
    getSoundLabel() {
        if (this.SoundLabelConfidence == false) {
            if (
                !this.soundProbableLabels ||
                this.soundProbableLabels.length === 0
            )
                return msg.Message.confidence_level[this.locale];
            this.SoundLabelConfidence = true;
        }
