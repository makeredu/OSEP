...
class chart {
    ...
    showChart(args) {
        ...
        if (data != "" && data != "資料") {
            if (chart == "折線圖") this.showLineChart();
            if (chart == "長條圖") this.showBarChart();
            if (chart == "圓餅圖") this.showPieChart();
            if (chart == "環形圖") this.showDoughnutChart();
            if (chart == "雷達圖") this.showRadarChart();
        } else
            return "請讀取資料";
    ...
    showLineChart() {
        ...
        for (var i = 1; i < keys.length; i++) {
            ...
            if (this.chartLabel.length >= i)
                label = this.chartLabel[i - 1];
    ...
    writeLabel(args) {
        this.chartLabel.push(args.label);
    }
}
