...
class rwGoogle {
        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: msg.writeGoogleSheetCol_2[theLocale],
                },
                {
    ...
    writeGoogleSheetCol_1(args) {
        const defVALUE = "欄位2,欄位3,...";
        const value = args.value;

        if (this.googleSheetURL_1 != "" && args.value != defVALUE) {
            if (value != "") {
                this.googleSheetData_1 = value;
            }
        }
    }

    writeGoogleSheetCol_2(args) {
        const value1 = args.value1.trim();
        const value2 = args.value2.trim();
        const value3 = args.value3.trim();
    ...
    async readGoogleSheet_json(args) {
        ...
        const row_e_value = parseInt(args.ROW_e, 10);
    ...
    sendGoogleSheet_1() {
        //var url = this.googleSheetURL + "?" + this.googleSheetData.slice(0, -1);
        const exec = `https://script.google.com/macros/s/AKfycbweGFfbHCyR16s5wsOssZ2CVQINaxg1l8QBzSHnt-cG-1qbbl5YEIJBM0LF1LfRmhw/exec`;
        //const sheetUrl = this.googleSheetURL;
        //const sheetTag =this.googleSheetTAG;
        let a = {
        ...
        //console.log(`${exec}?${a}`);
        if (this.googleSheetURL_1 != "") {
            if (this.googleSheetData_1 != "") {
                //fetch(url, { mode: "no-cors", credentials: "include" });
