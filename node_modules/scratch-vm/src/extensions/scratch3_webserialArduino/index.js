...
class Scratch3ArduinoWebSerial {
    ...
    // command blocks
    async flash_hex(args) {
        //const ports = args.USB;
        ...
        /*  
          ...
          */
        //  const hex =fetch('http://127.0.0.1:8601/static/hex/arduino_webserial_cc.ino.hex',{method:'get'});
        //  var pp = document.createElement('a');
        //  pp.setAttribute('href', 'data:text/plain;charset=utf-8,' + encodeURIComponent(hex));
        //  pp.setAttribute('download', 'hex.hex');
        /*
        const hex ='/static/hex/arduino_webserial_cc.ino.hex';
        await avrgirl.flash(hex, function (error) {
            if (error) {
            console.error(error);
            } else {
            console.info('done.');
    ...
    async tone_on(args, util) {
        ...
        const toneArray2 = [
            33, 35, 37, 39, 41, 44, 46, 49, 52, 55, 58, 62, 65, 69, 73, 78, 82,
            87, 93, 98, 104, 110, 117, 123, 131, 139, 147, 156, 165, 175, 185,
            196, 208, 220, 233, 247, 262, 277, 294, 311, 330, 349, 370, 392,
            415, 440, 466, 493, 523, 554, 587, 622, 659, 698, 740, 784, 831,
            880, 932, 988,
        ];
        ...
        let sendData =
            "tonePlay#" + split_pin[0] + "#" + valueFreq + "#" + duration;
        console.log("sendData:", sendData);
        this.serialSend(sendData);
    ...
    async servo(args) {
        ...
        let sendData = "servoWrite#" + split_pin[0] + "#" + angle;
        //console.log('sendData:',sendData);
        this.serialSend(sendData);
    }
    ...
    async digitalWrite(args) {
        ...
        //value = parseInt(value, 10);
        let sendData;
        sendData = "digitalWrite#" + split_pin[0] + "#" + value.toString();
        this.serialSend(sendData);
    }
    //I2C lcd
    async lcd_show(args) {
    ...
    async pms_read(args) {
        ...
        let pms_return = (await this.serialRead()).split(",");
        console.log(pms_return);
        pms_1 = pms_return[0];
        pms_25 = pms_return[1];
    ...
    async digital_read(args) {
        ...
        let split_pin = pin.split("(");
        //pin = parseInt(pin, 10);
        let sendData = "digitalRead#" + split_pin[0];
        console.log("sendData:", sendData);
        this.serialSend(sendData);
